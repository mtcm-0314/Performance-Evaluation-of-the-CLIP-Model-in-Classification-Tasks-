...
class ImageTextData(object):
    ...
    _DATA_FOLDER = [
        ...
        'dataset/ChestXray/train', # 12
        'dataset/ChestXray/test'

        'dataset/Adaptiope/P',  # 13
        'dataset/Adaptiope/P',

        'dataset/NoisyDA/gaussian_noise1',  # 14
        'dataset/NoisyDA/gaussian_noise2',  # 15
        'dataset/NoisyDA/gaussian_noise3',  # 16
        'dataset/NoisyDA/gaussian_noise4',  # 17
        'dataset/NoisyDA/gaussian_noise4',  # 18
        'dataset/NoisyDA/global',       # 19

        'dataset/Eye_disease/train',  # 20
